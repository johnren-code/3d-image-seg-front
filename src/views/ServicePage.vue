    ...
    <Layout>
        ...
        <section class="rn-service-area rn-section-gap">
            <div class="container">
                <div class="row row--30">
                    <div class="col-lg-12">
                        <SectionTitle class="mb--50" text-align="center" subtitle="What we can do for you"
        ...
        <section class="rn-service-area rn-section-gap">
            <div class="container">
                ...
                <ServiceOne service-style="service__style--1 bg-color-blackest radius mt--25 rbt-border" icon-size="62"
                    text-align="left" />
            </div>
        </section>
        <!-- End Service Area -->
        ...
        <section class="rn-service-area rn-section-gap">
            <div class="container">
                ...
                <ServiceFour service-style="service__style--1 icon-circle-style with-working-process" text-align="center" />
            </div>
        </section>
        <!-- End Service Area -->
